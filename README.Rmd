...
table(diplom = fake_data$hs_diploma, dropout = fake_data$dropout)
table(diplom = fake_data$hs_diploma, transferout = fake_data$transferout)
table(diplom = fake_data$hs_diploma, still_enroll = fake_data$still_enrolled)

table(fake_data$enroll_yr2_any)
table(yr1 = fake_data$enroll_yr1_any, yr2 =fake_data$enroll_yr2_any)

table(diplom = fake_data$hs_diploma, 
      yr1 = fake_data$enroll_yr1_any)

table(diplom = fake_data$hs_diploma, 
      yr2 =fake_data$enroll_yr2_any)
...
grad_sim <- do.call(gen_outcome_model, grad_sim_parameters)
